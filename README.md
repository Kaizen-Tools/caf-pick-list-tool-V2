...
- The app shows a configurable separate issue pack threshold. The default is `20` lines.
...
- The app also shows a configurable master pick page line limit. The default is `20` lines per master pick page.
